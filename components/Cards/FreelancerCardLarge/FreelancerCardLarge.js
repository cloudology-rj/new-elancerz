...
const FreelancerCardLarge = (props) => {
  return (
    <CardContainer>
      <CardImage
      ...
      <CardContent>
        <FlexBetween>
          <div>
            <HeaderThree>Roger Vetrovs</HeaderThree>
            <Bold>UI/UX Designer</Bold>
            <PreTitle>PHiladelphia, CA</PreTitle>
          </div>

          <FlexCenter>
            <div>
              <Image src="/icons/yellow-star.svg" width={40} height={38} />
              <Image src="/icons/yellow-star.svg" width={40} height={38} />
              <Image src="/icons/yellow-star.svg" width={40} height={38} />
              <Image src="/icons/yellow-star.svg" width={40} height={38} />
              <Image src="/icons/white-star.svg" width={40} height={38} />
            </div>
        ...
        <div>
          <CardDescription>
            Vitae, urna vitae orci hac vitae ut gravida cras pretium. Aenean
            facilisis tortor arcu, vel pharetra ipsum ipsum magna parturient.
            Proin pretium, integer quis sit quam. Sed elementum nulla turpis
            lectus magna mauris. Sociis sagittis sagittis, feugiat aliquet
            posuere amet at. Sollicitudin eget ut id enim. Tortor aliquam sed et
            aenean ultrices tempor iaculis.
          </CardDescription>
        </div>
      </CardContent>
    </CardContainer>
